...
let RemindersController = class RemindersController {
    scheduleReminder;
    constructor(scheduleReminder) {
        this.scheduleReminder = scheduleReminder;
    }
    async schedule(body) {
        return this.scheduleReminder.execute(body.appointmentId, new Date(body.scheduledFor));
    }
};
...
], RemindersController.prototype, "schedule", null);
exports.RemindersController = RemindersController = __decorate([
    (0, common_1.Controller)("reminders"),
    __metadata("design:paramtypes", [schedule_reminder_1.ScheduleReminder])
], RemindersController);
