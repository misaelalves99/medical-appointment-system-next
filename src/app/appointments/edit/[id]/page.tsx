...
export default function EditAppointmentPage() {
  ...
  const handleChange = (
    ...
    setFormData((previous: AppointmentForm) => ({ ...previous, [name]: value }));
  };
  ...
  return (
    <section className={styles.workspace} aria-labelledby="edit-appointment-title">
      <header className={styles.header}>
        <div>
          <p className={styles.eyebrow}>Agenda clínica</p>
          <h1 id="edit-appointment-title" className={styles.title}>
            Editar Consulta
          </h1>
          <p className={styles.description}>
            Atualize os dados da consulta mantendo paciente, profissional e status consistentes.
          </p>
        </div>
      ...
      <div className={styles.formCard}>
        <div className={styles.formIntro}>
          ...
          <p id="edit-required-guidance" className={styles.formGuidance}>
        ...
        <form
          ...
          aria-describedby="edit-required-guidance"
        >
